const contentLetterSrart_actived =
    "Happy birthday ( 20/5 )! E hèm bấm vào hộp quà ở dưới này nhá kaka."; //Lời mở đầu cho bức thư
const mainContentLetter =
    "Chúc em nhật vui vẻ! Hãy bỏ qua mọi lo toan, phiền muộn trong lòng, tiếp tục theo đuổi ước mơ và trở thành phiên bản tốt nhất của chính mình nha. Chúc em luôn tràn đầy năng lượng và thành công trong mọi việc nhé ^^!  Happy birthday Thúy ( 20-5-2003 )"; //Nội dung của bức thư

// Gắn 1 đường link ảnh bất kì
let imgStart = document.querySelector(".myAI"); //Hình ảnh xuất hiện trong lời mở đầu của bức thư
imgStart.src = "./img/anhdaden.png";
